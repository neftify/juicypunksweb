          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-4 mb-10">
              <div className="text-center max-w-xs mx-auto">
                <img className="w-24 h-24 mx-auto mb-6 rounded-full" src="flex-ui-assets/images/teams/avatar1.png" alt="" /><h3 className="mb-1 text-lg text-coolGray-800 font-semibold">Ernesto</h3>
                ...
                <div className="flex items-center justify-center">
                  <a className="inline-block mr-5 text-coolGray-300 hover:text-coolGray-400" href="#">
                    <svg width={10} height={18} viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M6.63494 17.7273V9.76602H9.3583L9.76688 6.66246H6.63494V4.68128C6.63494 3.78301 6.88821 3.17085 8.20297 3.17085L9.87712 3.17017V0.394238C9.5876 0.357335 8.59378 0.272728 7.43708 0.272728C5.0217 0.272728 3.3681 1.71881 3.3681 4.37391V6.66246H0.636475V9.76602H3.3681V17.7273H6.63494Z" fill="currentColor" /></svg></a>
                  <a className="inline-block mr-5 text-coolGray-300 hover:text-coolGray-400" href="#">
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-4 mb-10">
              <div className="text-center max-w-xs mx-auto">
                <img className="w-24 h-24 mx-auto mb-6 rounded-full" src="flex-ui-assets/images/teams/avatar2.png" alt="" /><h3 className="mb-1 text-lg text-coolGray-800 font-semibold">Steven</h3>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-4 mb-10">
              <div className="text-center max-w-xs mx-auto">
                <img className="w-24 h-24 mx-auto mb-6 rounded-full" src="flex-ui-assets/images/teams/avatar3.png" alt="" /><h3 className="mb-1 text-lg text-coolGray-800 font-semibold">OWTLW</h3>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-4 mb-10 xl:mb-0">
              <div className="text-center max-w-xs mx-auto">
                <img className="w-24 h-24 mx-auto mb-6 rounded-full" src="flex-ui-assets/images/teams/avatar5.png" alt="" /><h3 className="mb-1 text-lg text-coolGray-800 font-semibold">Luis</h3>
